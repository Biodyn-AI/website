/* ========================================
   SONDE, renders content/evals.json
...
(() => {
  const DATA_URL = 'content/evals.json?v=16';
  ...
  document.addEventListener('DOMContentLoaded', async () => {
    ...
    try {
      ...
      const msg = `Could not load ${DATA_URL} (${err.message}). Results are generated by the SONDE harness.`;
